...
words5 = [["False"," - "],["True","Potentielle erreur d'association sur le code ATC"]]
...
#Applied on Uncertainty
Unmatched = 0
for i, row in df.iterrows() :
    if converter2(df, i, 7,words5) == False :
        Unmatched += 1
    converter_r(df, i, 7)
print(str(Unmatched) + " U rows unmatched")
